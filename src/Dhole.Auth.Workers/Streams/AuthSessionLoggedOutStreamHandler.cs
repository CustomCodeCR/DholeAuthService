...
internal sealed class AuthSessionLoggedOutStreamHandler(
    ILogger<AuthSessionLoggedOutStreamHandler> logger
) : IRedisStreamMessageHandler
{
    public string MessageType => "auth.session.logged_out";
